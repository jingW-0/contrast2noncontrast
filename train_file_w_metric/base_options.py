...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', default='D:\\contrast\\image\\100_iso\\axial',
        ...
        parser.add_argument("--read_folder", type=bool, default=False)

        parser.add_argument("--with_metric", type=bool, default=True)
        parser.add_argument("--metric_tol", type=float, default=0.5)
        parser.add_argument("--ssim_th", type=float, default=0.5)
        parser.add_argument("--max_itr", type=int, default=100)

       
        parser.add_argument('--name', type=str, default='CUT3', help='name of the experiment. It decides where to store samples and models')
        parser.add_argument('--easy_label', type=str, default='CUT3', help='Interpretable name')
        parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        parser.add_argument('--checkpoints_dir', type=str, default='./checkpoints_mix', help='models are saved here')
      
        # model parameters
        parser.add_argument('--model', type=str, default='cut3', help='chooses which model to use.')
        ...
        parser.add_argument('--input_mode', type=str, default='patch', choices=['full', 'patch'],
                            help='if use patch, random crop from input image')
        parser.add_argument('--patch_size', default=256, help='Size of the patches extracted from the image')

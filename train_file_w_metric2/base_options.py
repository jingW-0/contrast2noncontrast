...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument("--with_metric", type=str, default='metric', help="choose from 'metric', 'ssim', or None")
        ...
        parser.add_argument('--name', type=str, default='CUT', help='name of the experiment. It decides where to store samples and models')
        parser.add_argument('--easy_label', type=str, default='CUT', help='Interpretable name')
